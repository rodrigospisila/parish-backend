...
const isNonParishUnit = (name: string) =>
  /^(Capela|Igreja|Capelania|Miss[ãa]o|Orat[óo]rio|Comunidade|Mosteiro|Convento|Monjas|Monges|Abadia|Carmelo|Semin[áa]rio|Setor Mission[áa]rio)\b/i.test(name.trim());
